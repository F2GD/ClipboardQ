...
let tray = null;
let clipboardQueue = [];
let clipboardQueueLimit = 500; // limit to 100 items, you can change this to any desired value
let copiedHistory = []; // to store the last 10 copied items
const copiedHistoryLimit = 500; // limit to 10 items, you can change this to any desired value
